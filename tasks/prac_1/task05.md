...
select fs.V_NAME as V_SERVICE_NAME, tmp_sum.ID_DEPARTMENT as ID_DEPARTMENT,
fs.ID_SERVICE as ID_SERVICE_TYPE, sum(tmp_sum.N_TOTAL_COST) as N_TOTAL_SERVICE_COST
...
group by fs.V_NAME, tmp_sum.ID_DEPARTMENT, fs.ID_SERVICE
order by sum(tmp_sum.N_TOTAL_COST) desc
